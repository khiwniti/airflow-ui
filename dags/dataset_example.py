...
def dataset_example_pipeline():
    ...
    def extract_sales_data() -> List[Dict]:
        ...
        sales_data = [
            {'sale_id': 1, 'customer_id': 1, 'amount': 100.50, 'date': '2024-01-01'},
            {'sale_id': 2, 'customer_id': 2, 'amount': 250.75, 'date': '2024-01-02'},
            {'sale_id': 3, 'customer_id': 1, 'amount': 75.25, 'date': '2024-01-03'},
        ]
